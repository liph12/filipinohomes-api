...
class AmenitiesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $amenities = [
            ...
            ['id' => 32, 'name' => 'Drying Area', 'slug' => 'drying-area'],
            ['id' => 33, 'name' => 'Fire Alarm', 'slug' => 'fire-alarm'],
            ['id' => 34, 'name' => 'Jacuzzi', 'slug' => 'jacuzzi'],
            ...
            ['id' => 55, 'name' => 'Jacuzzi 2', 'slug' => 'jacuzzi2'],
            ...
            ['id' => 60, 'name' => 'Drying Area 2', 'slug' => 'drying-area2'],
            ['id' => 61, 'name' => 'Sauna 2', 'slug' => 'sauna2'],
