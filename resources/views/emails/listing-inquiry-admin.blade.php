...
@php
    // ui-avatars.com initials fallback so the layout never breaks when a
    // user has no profile picture. Same helper used across the email
    // templates — kept inline so each blade renders standalone.
    ...
    $hasTeam = !empty($teamName);
    $resolvedTeamName = $hasTeam ? $teamName : '(unassigned)';
@endphp
                    ...
                    <td align="center" valign="top" style="margin:0;padding:0;">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%"
                            ...
                            <tbody>
                                ...
                                {{-- RIBBON — amber/orange tone signals "needs review" so admins
                                     scanning a packed inbox can prioritize at a glance. --}}
                                <tr>
                                    <td align="center" valign="middle"
                                        style="background:#b45309;padding:14px 24px;">
                                        <span style="font-size:13px;line-height:18px;font-family:Helvetica,Arial,sans-serif;color:#ffffff;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;">
                                            🏠 New Listing Inquiry — Pending Review
                                        </span>
                                        <br />
                                        <span style="font-size:12px;line-height:18px;font-family:Helvetica,Arial,sans-serif;color:#fde68a;">
                                            Awaiting admin or team-leader approval
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="center" valign="top"
                                        ...
                                        <span
                                            ...
                                            New Inquiry Pending Review
                                        </span>
                                    </td>
                                </tr>

                                {{-- GREETING — generic "Admin" label, never a specific name. --}}
                                <tr>
                                    <td align="left" valign="top"
                                        ...
                                        <span
                                            ...
                                            Hello Admin,
                                            <br /><br />
                                            A new property inquiry has been submitted on Filipino Homes and is awaiting review. Please look it over and accept or reject it from the admin inbox.
                                        </span>
                                    </td>
                                </tr>

                                {{-- TEAM CALLOUT — when the agent is on an active team, this
                                     surfaces who's responsible (amber, informational). When
                                     the agent has NO team yet, it switches to a louder red
                                     warning so admins notice before accepting — the inquiry
                                     can't auto-route to a team leader without a team. --}}
                                @if ($hasTeam)
                                <tr>
                                    <td align="left" valign="top" style="background-color:#ffffff;padding:0 40px 18px;">
                                        <div style="padding:14px 18px;background:#fef3c7;border-left:3px solid #b45309;border-radius:6px;">
                                            <span style="font-size:11px;line-height:16px;font-family:Helvetica,Arial,sans-serif;color:#92400e;letter-spacing:0.06em;text-transform:uppercase;font-weight:700;display:block;margin-bottom:4px;">
                                                Agent Team
                                            </span>
                                ...
                                <tr>
                                    <td align="left" valign="top" style="background-color:#ffffff;padding:0 40px 18px;">
                                        <div style="padding:16px 18px;background:#fee2e2;border-left:4px solid #b91c1c;border-radius:6px;">
                                            <span style="font-size:11px;line-height:16px;font-family:Helvetica,Arial,sans-serif;color:#991b1b;letter-spacing:0.06em;text-transform:uppercase;font-weight:700;display:block;margin-bottom:6px;">
                                                ⚠️ Action Needed — Agent Not On A Team
                                            </span>
                                            <span style="font-size:14px;line-height:20px;font-family:Helvetica,Arial,sans-serif;color:#7f1d1d;font-weight:600;display:block;margin-bottom:4px;">
                                                This listing's agent isn't assigned to any team yet.
                                            </span>
                                            <span style="font-size:13px;line-height:19px;font-family:Helvetica,Arial,sans-serif;color:#7f1d1d;display:block;">
                                                No team leader was notified about this inquiry. Consider assigning the agent to a team in the admin panel before accepting, so future inquiries route correctly.
                                            </span>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                {{-- MESSAGE BODY — only rendered when the client actually typed
                                     something. A no-message inquiry is still a lead (listing +
                                     contact info), so we don't suppress the whole email — just
                                     the empty quote card. --}}
                                @if (!empty($message))
                                <tr>
                                    <td align="left" valign="top"
                                ...
                                {{-- LISTING OWNER (the agent) — admins always see this so they
                                     know who the inquiry should ultimately route to. --}}
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center" valign="middle" style="padding:0 6px;">
                                                        <a href="{{ $frontendUrl }}/inbox/{{ $slug }}"
                                                            style="display:inline-block;padding:14px 28px;font-size:15px;font-family:Helvetica,Arial,sans-serif;color:#ffffff;background-color:#b45309;border-radius:999px;text-decoration:none;font-weight:600;line-height:1;">
                                                            Review Inquiry
                                                        </a>
                                                    </td>
                                                </tr>
                                ...
                                <tr>
                                    <td align="center" style="padding:18px 40px 28px;background:#f8fafc;">
                                        <span style="font-size:11px;line-height:16px;font-family:Helvetica,Arial,sans-serif;color:#94a3b8;">
                                            You're receiving this because you're an admin at Filipino Homes.
                                        </span>
                                    </td>
                                </tr>
