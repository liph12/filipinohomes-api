                    ...
                    <td align="center" valign="top" style="margin:0;padding:0;">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%"
                            ...
                            <tbody>
                                ...
                                {{-- RIBBON — teal/green tone signals "ready to act" so agents
                                     immediately know the inquiry has passed admin review. --}}
                                <tr>
                                    <td align="center" valign="middle"
                                        ...
                                        <span style="font-size:12px;line-height:18px;font-family:Helvetica,Arial,sans-serif;color:#d1fae5;">
                                            Reviewed and ready for your response
                                        </span>
                                    </td>
                                </tr>
                                ...
                                {{-- GREETING — personalized; agent receives this individually
                                     via BCC behind info@filipinohomes.com. --}}
                                <tr>
                                    <td align="left" valign="top"
                                        ...
                                        <span
                                            ...
                                            <br /><br />
                                            An inquiry on your listing has been reviewed by the Filipino Homes team and is now assigned to you. Please respond at your earliest convenience to keep the lead warm.
                                        </span>
                                    </td>
                                </tr>
                                ...
                                {{-- Listing-owner block is intentionally OMITTED here. The
                                     agent IS the listing owner — echoing their own contact
                                     info back at them would be noise. --}}
