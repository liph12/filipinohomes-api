    ...
    public function toArray(Request $request): array
    {
        ...
        $lastLoginAt = array_key_exists('login_logs_max_logged_in_at', $userAttrs)
            ? ($userAttrs['login_logs_max_logged_in_at']
                ? Carbon::parse($userAttrs['login_logs_max_logged_in_at'])->toISOString()
                : null)
        ...
        return [
            ...
            // denominator for "responded X of Y inquiries" displays.
            'total_inquiries_count' => $this->total_inquiries_count ?? 0,
